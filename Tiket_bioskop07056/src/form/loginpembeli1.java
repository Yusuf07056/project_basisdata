...
public class loginpembeli1 extends javax.swing.JFrame {
...
userlog user = new userlog();
     ...
     */
    public loginpembeli1() throws SQLException {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.add(login);
        login.setBounds(650, 580, 300, 90);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(loginpembeli1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ...
                    Logger.getLogger(loginpembeli1.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
